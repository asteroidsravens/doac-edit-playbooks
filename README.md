# DOAC / Swarm Edit Playbooks

Reusable editing skills for **talking-head Shorts**, **YouTube Shorts thumbs**, **full-episode long-form** (DOAC/Lex-style packaging), and **episode-clip Shorts** (heresy-title formula).

Built so a second editor (or another agent) can follow the same craft without inventing a new look.
...
1. Clone this repo.
2. Open the matching `SKILL.md` for the job.
...
- These are craft playbooks (FFmpeg/ASS/Pillow level), not CapCut project files.
- Brand names and example episodes in the skills are illustrative grammar — apply to your show’s assets.

## License

Private craft shared for collaboration. Ask before redistributing.
